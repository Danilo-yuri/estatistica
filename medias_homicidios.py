...
def estimativas_variabilidade(dados_brutos, media):
   ...
   """
    ...
    df_desvios_individuais = pd.DataFrame({
        ...
        'Desvio (taxa homicidios - média)': desvios,
    ...
    df_amplitudes = pd.DataFrame({
        ...
        'Amplitude interquadril (Q3 - Q1)': amplitude_interquartil,
        'Mediana (Q2)': mediana
...
estimativas_variabilidade(df_dados_brutos['Taxa_homicidios'], np.mean(df_dados_brutos['Taxa_homicidios']))